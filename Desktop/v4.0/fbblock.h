...
struct FBBlockSetupParameters 
{
 ...
 float resolution[3];      // This is actually the vertex size
 int block_x_position; 	int block_y_position; 	int block_z_position;
...
public:
    ...
    float get_sigma_v(int x, int y, int z); // "v" stands for "von Mises yield criterion" or 
